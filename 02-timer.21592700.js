...
})({"9oEBi":[function(require,module,exports) {
...
const options = {
    ...
    onClose (selectedDates) {
        ...
        if (deltaTime <= 0) (0, _notiflixDefault.default).Notify.failure("Please choose a date in the future");
        else {
...
function updateTimer({ days, hours, minutes, seconds }) {
    ...
    if (secondsElement) {
        ...
        if (seconds < 10) secondsElement.classList.add("red-text");
        else secondsElement.classList.remove("red-text");
    } else console.error("Element with data-seconds not found");
}
...
},{}],"eVN6V":[function() {},{}]},["9oEBi","5WT9K"], "5WT9K", "parcelRequire7bc7")
